...
public interface ContinuousGlucoseMonitorStatusCallback extends ContinuousGlucoseMonitorTypes {
	 ...
	 * If CRC check has failed, the {@link #onContinuousGlucoseMonitorStatusReceivedWithCrcError(Data)}
	 ...
	 *                   invalid CRC value check {@link #onContinuousGlucoseMonitorStatusReceivedWithCrcError(Data)}.
	 */
	void onContinuousGlucoseMonitorStatusChanged(final CGMStatus status, final int timeOffset,
	 ...
	 */
	default void onContinuousGlucoseMonitorStatusReceivedWithCrcError(final @NonNull Data data) {
		// ignore
	}
}
